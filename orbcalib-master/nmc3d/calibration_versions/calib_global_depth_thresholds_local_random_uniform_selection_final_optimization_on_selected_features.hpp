...
private:
    ...
    bool bDepthBalancedThresholdsReady = false;
    float depthBalancedNearThreshold = 0.0f;
    float depthBalancedFarThreshold = 0.0f;
...
public:
    ...
    void ComputeGlobalDepthThresholds();

    vector<MapPoint*> SelectDepthBalancedMatches(KeyFrame* pKF1, KeyFrame* pKF2, const vector<MapPoint*>& vpMatches);
